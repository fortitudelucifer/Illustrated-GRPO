"""
Stage 4 Evaluation: Compare 1.5B model accuracy before/after GRPO training
- 500 held-out 3-digit addition problems
...
def main():
    print("=" * 70)
    print("Stage 4 Evaluation: 500 questions x 5 seeds x 2 models")
    print("=" * 70)
    ...
    output_path = "/output/eval_results_500.json"
